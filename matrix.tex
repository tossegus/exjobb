...
This appendix contains a selection of vectors and matrixes used in 
the thesis. The contents found in this appendix take too much space, 
and are not relevant enough to be inserted into the chapters of the 
thesis.

All of the matrixes are defined as they are written here, and do not
differ.
